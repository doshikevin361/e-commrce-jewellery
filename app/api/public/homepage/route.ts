...
export async function GET() {
  try {
    ...
    const [rawBanners, rawCategories, rawFeatured, rawTrending, rawNew, rawDazzle, rawGallery, rawNews] = await Promise.all([
      ...
      safeQuery(dazzlePromise, 'dazzle section', null),
