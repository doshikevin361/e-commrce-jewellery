...
import { Diamond, XCircle, Clock, DollarSign, Mail } from 'lucide-react';
  ...
  const sections = [
    {
      ...
      content: [
        ...
        'Orders that have already been processed or shipped cannot be cancelled, but may be returned according to our Return Policy.',
        'Once an order has been cancelled, you will receive a confirmation email, and your refund will be processed within 5-10 business days.',
      ],
    },
    {
      title: 'How to Cancel',
      icon: Clock,
      content: [
        'Contact us via email at oripiostudio@gmail.com or call +8801701253995.',
        'Provide your order number and the reason for cancellation.',
        'Our customer service team will process your cancellation request and send you a confirmation email.',
    ...
    },
    {
      ...
      content: [
        ...
        'Orders that have entered the production or shipping stage may incur cancellation fees.',
        'Custom or personalized orders cannot be cancelled once production has begun.',
        'We reserve the right to cancel any order due to stock unavailability, pricing errors, or fraudulent activity.',
      ],
    },
    {
      ...
      icon: DollarSign,
      content: [
        'Full refunds will be issued for orders cancelled within 24 hours.',
        ...
        <section className='relative w-full h-[350px] sm:h-[450px] md:h-[550px] lg:h-[600px] overflow-hidden'>
          ...
          <div className='relative z-20 h-full flex flex-col justify-center items-center text-center px-3 sm:px-4 md:px-6 text-white'>
            <div className='flex items-center justify-center gap-2 mb-4 sm:mb-5'>
              ...
              <XCircle size={28} className='sm:w-8 sm:h-8 md:w-10 md:h-10 text-white' />
