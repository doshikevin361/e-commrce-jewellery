  ...
  return (
            ...
            <div className='flex items-center gap-3 sm:gap-4 lg:gap-6 py-3 lg:py-4 min-w-0'>
              <div className='flex items-center gap-3 sm:gap-4 shrink-0 min-w-0'>
                ...
                <Link href='/' className='shrink-0 flex items-center gap-3'>
                  <div className='flex items-center justify-center h-10 w-10 sm:h-12 sm:w-12 lg:h-24 lg:w-24 overflow-hidden'>
              ...
              <div className='flex-1 min-w-0 flex justify-center px-1 sm:px-2'>
                <div className='w-full max-w-[700px] min-w-0'>
                  <form
                    ...
                    ${searchFocused ? 'border-[#a05a64]/80 bg-white' : 'border-stone-200 bg-stone-50 hover:border-stone-300'}`}
                    />
                    <button
                      type='submit'
              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2 shrink-0'>
                  ...
                  <div
                    ...
                    {liveRateOpen && (
                      <div className='absolute right-0 top-full mt-3 w-80 z-50 animate-dropdownFade'>
                        <div
                          className='rounded-2xl border border-[#a05a64]/20 bg-white/70 backdrop-blur-xl 
    shadow-[0_10px_40px_rgba(160,90,100,0.25)] overflow-hidden'>
      ...
      border-b border-[#a05a64]/20'>
                            <p className='text-[11px] font-semibold text-[#a05a64] uppercase tracking-[0.15em]'>Live Metal Rates</p>
                          </div>

                          {/* Content */}
                          <div className='py-3 px-4 space-y-2'>{renderGoldRatesRows()}</div>
