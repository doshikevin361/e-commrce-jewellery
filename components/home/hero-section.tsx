    ...
    <section className='container mx-auto px-4 py-8'>
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
        ...
        <div className='lg:col-span-2 space-y-4'>
          ...
          >
            ...
            <div className='relative h-full flex flex-col justify-end items-start p-8 text-white'>
              <p className={`text-sm mb-2 font-medium text-white/90 transform transition-all duration-700 delay-200 ${
                isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'
              }`}>Holiday &apos;25 Collection</p>
              <h2 className={`text-5xl font-bold mb-6 text-white transform transition-all duration-700 delay-300 ${
                isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'
              }`}>Relic Relaxed</h2>
              <button className={`bg-white text-[#6B46C1] px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 hover:scale-105 transition-all duration-300 delay-400 transform ${
          ...
          <div className={`relative overflow-hidden rounded-lg h-[190px] bg-[#6B46C1] transform transition-all duration-1000 delay-200 ${
        ...
        <div className='space-y-4'>
          ...
          <div className={`relative overflow-hidden rounded-lg h-[290px] bg-[#EC4899] transform transition-all duration-1000 delay-300 ${
            isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
          }`}>
          ...
          <div className={`relative overflow-hidden rounded-lg h-[290px] bg-[#991B1B] transform transition-all duration-1000 delay-400 ${
            isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
          }`}>
